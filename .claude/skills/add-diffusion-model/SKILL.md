...
If you add `examples/online_serving/<name>/`, usually add a matching `tests/e2e/online_serving/test_<name>_expansion.py` following the existing `test_*_expansion.py` convention.
