...
Usage:
    python generate_tokenizer_files.py --output /path/to/output
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate VibeVoice tokenizer files from Qwen2 base")
    parser.add_argument(
        "--output", "-o", type=str, default=None, help="Output directory for generated files (default: temp directory)"
    )
    parser.add_argument(
        "--compare", "-c", type=str, default=None, help="Reference directory to compare generated files against"
    )
    parser.add_argument(
        "--qwen-model",
        type=str,
